...
//     //         });
//     // });
//     it("TC-205-6 User has been added successfully", (done) => {
//         chai.request(server)
//             .put("/api/user/1")
//             .send({
//                 firstName: "Klaas",
...
//         chai.request(server)
//             .delete("/api/user/" + deletableUserId) //TODO:if user has been delete he is removed from db, so when test runs again the user has already been deleted
//             .end((req, res) => {
//                 let { status } = res.body;
//                 status.should.equals(201);
//                 done();
